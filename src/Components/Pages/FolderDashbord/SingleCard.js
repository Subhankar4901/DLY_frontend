...
const Single = ({ carddata }) => {
  ...
  return (
    <div className="p-4 border rounded card-design">
      <div
        className="box"
        style={{
          position: "relative",
      ...
      >
        ...
        <div className="card-list mb-5">
          <div className="card-list-title">contents</div>
          <ul className="card-list-title ul-margin">
            <div>
              <li>Pitch book</li>
              <li>Sales report</li>
              <li>Presentation deck</li>
              <li>Memo</li>
              <li>Financial modal</li>
              <li>Sheet template</li>
              <li>Blank file</li>
              <li>Build Chart</li>
            </div>
          </ul>
